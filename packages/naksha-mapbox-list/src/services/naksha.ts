...
export const axGexGetRasterInfoWithLonLat = async (endpoint,workspace,params)=>{
  ...
  try {
    const  res  = await axios.get(`${endpoint}/${workspace}/wms`,{params:{...params,...RasterInfoParams}});
