...
export const IconRemoveCircle = createIcon({
...
export const IconCredit = createIcon({
  displayName: "Credit",
  viewBox: "0 0 16 16",
  path: (
    <path
...
export const IconEyeOn = createIcon({
  displayName: "Eye Off",
  viewBox: "0 0 16 16",
  path: (
    <>
